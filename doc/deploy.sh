...
dir_base='/opt/cameraservice'
deploy_name='cameraservice'
dir_git='/opt/cameraservice/git_src'
dir_backup='/opt/cameraservice/backup'
dir_deploy='/opt/cameraservice/cameraservice'
dir_mvntarget='/opt/cameraservice/git_src/target/cameraservice'

#下载代码
#cd /opt/cameraservice
#git XXXX git_src
#更新代码
...
sleep 10
killall -9 java
#mysql -h IP -u"user" -p"password" cameraservice  < /opt/cameraservice/db_sql/db.sql
